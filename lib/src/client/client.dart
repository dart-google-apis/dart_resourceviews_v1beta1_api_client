...
abstract class Client extends ClientBase {
  core.String basePath = "/resourceviews/v1beta1/projects/";
  ...
  RegionViewsResource_ get regionViews => new RegionViewsResource_(this);
  ZoneViewsResource_ get zoneViews => new ZoneViewsResource_(this);
